...
console.log(`-0/17 = ${-0/17}`);            // -0
console.log(`"Js"/187 = ${"Js"/187}`);      // NaN
console.log(`[1,9,8]/0 = ${[1,9,8]/0}`);    // NaN

// ================= FLOATING POINT =================
console.log(`202.2 * 2 = ${202.2 * 2}`);    // 404.4
console.log(`303.3 * 3 = ${303.3 * 3}`);    // 909.9000000000001
console.log(`0.1 + 0.2 = ${0.1 + 0.2}`);    // 0.30000000000000004

// ================= MATH FUNCTIONS =================
console.log(`Math.trunc(3.654) = ${Math.trunc(3.654)}`);             // 3       
console.log(`Math.round(7.876810) = ${Math.round(7.876810)}`);       // 8
console.log(`Math.floor(9.621793) = ${Math.floor(9.621793)}`);       // 9
console.log(`Math.ceil(5.66849846) = ${Math.ceil(5.66849846)}`);     // 6
console.log(`Math.max(8,9,0,19) = ${Math.max(8,9,0,19)}`);           // 19
console.log(`Math.min(9,10,18,10,-9,-6) = ${Math.min(9,10,18,10,-9,-6)}`);  // -9
console.log(`Math.pow(4,87) = ${Math.pow(4,87)}`);                   // 2.3945242826029513e+52
