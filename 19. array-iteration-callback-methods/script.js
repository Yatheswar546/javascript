...
function runMap() {
    ...
    document.getElementById("mapResult").innerText = mapArrayresult;
}
...
function runFilter() {
    ...
    document.getElementById("filterResult").innerText = filterArrayresult;
}
...
function runReduce() {
    ...
    document.getElementById("reduceResult").innerText = reduceArray1result;
}
